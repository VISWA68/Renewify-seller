...
class _AddShopPageState extends State<AddShopPage> {
  ...
  final _shopImageController =
      TextEditingController(); // For optional image URL
  ...
  Future<void> addShop() async {
    ...
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        'shop_image': _shopImageController.text, // Optional
      }),
    );
    ...
    if (response.statusCode == 201) {
      ...
      Navigator.pop(context); // Navigate back after successful shop addition
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
